...
从代数的角度来说， $x^4 = 1$ 有4个根，分别是 $[x_1, x_2, x_3, x_4]$, 然后这四个根分别做平方，也就是 $[x_1^2, x_2^2, x_3^2, x_4^2]$.
令:
...
这里 $x_1^2 == x_3^2 == -1,x_2^2 == x_4^2 == 1$  每做一次平方，根的数量少一半， 就是上面二叉树的结构。

单位根的这种树形递归的性质 就是 FFT 算法的核心。
